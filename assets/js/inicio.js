                ...
                <div class="col-md-10 col-lg-8 col-xl-10">
                    <div class="container">
                        <div class="d-flex justify-content-center mt-5" style="cursor: pointer; border-bottom: var(--bs-border-width) var(--bs-border-style) var(--bs-border-color) !important;">
                            <img style="width: 12rem; height: 16rem; padding-right: 1rem; border-radius: 0.5rem;" src="${img}" alt="${post.thumbImageAltText}">
                            <div class="p-4">
                                <h2 class="text-xl font-semibold mb-2 font-bold text-3xl">${post.title}</h2>
                                <a href="post.html?id=${index}" class="mt-4 inline-block text-blue-500 hover:underline">Ler mais...</a>
                                <br>
                                <p class="mt-2 text-gray-500 italic">Publicado por ${post.profileName} em ${post.postDate}</p>
                                <hr class="my-5"/>
                            </div>
                        </div>
                    </div>
